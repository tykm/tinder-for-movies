  ...
  return (
    <div>
      ...
      {isLogged ? (
        ...
        First, we allow our users to decide on a genre, then they can choose which movies they like within that genre.
        At the end of the voting the movie with the most user votes get displayed for everyone to see.
        From there they can decide to login into a different room or restart the voting in the same room.
        ...
        Our app allows for people to find new movies to enjoy themselves when they no longer know what to watch.
