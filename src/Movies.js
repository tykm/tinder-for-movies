...
export function Movies() {
    ...
    return (
    <div>
    {timerEnd ? <div> <Winner /> </div>: 
         isMoviePage ? <div>Waiting for others to finish!</div>:
            <div>
            {seconds}
            ...
            <div>
                <button onClick={() => {socket.emit('onSubmitMovies', movies); console.log(movies); setMoviePage(true);}}>Submit</button>
            </div>
            </div>
     }
    </div>
